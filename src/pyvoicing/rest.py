class Rest(int):
    ...
    def __repr__(self): return "Rest()"
    def __str__(self): return "Rest()"
    ...
    def __eq__(self, other): return isinstance(other, Rest)
    def __ne__(self, other): return not isinstance(other, Rest)
